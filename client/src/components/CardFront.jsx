    ...
    if (!project) {
        ...
        return (
            <div id="mask">
                ...
                <p style={{ fontSize: "16pt", fontWeight: "bold", marginBottom: "30px" }}> <span style={{ fontSize: "18pt" }}>&#123;</span> {project.technologies} <span style={{ fontSize: "18pt" }}>&#125;</span></p>
                <p style={{ fontSize: "14pt", marginBottom: "30px" }}>{project.summary[0]}</p>
